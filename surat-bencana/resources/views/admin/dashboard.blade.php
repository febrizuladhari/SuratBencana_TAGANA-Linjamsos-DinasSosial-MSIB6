        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Korban Terdampak (Jiwa)
                            </div>
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">162</div>
                                </div>
                                {{-- <div class="col">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-4 text-center small">
                        <span class="mr-2">
                            <i class="fas fa-circle text-primary"></i> Paket Sandang
                        </span>
                        <span class="mr-2">
                            <i class="fas fa-circle text-success"></i> Buffer Stock
                        </span>
                        <span class="mr-2">
                            <i class="fas fa-circle text-info"></i> Permakanan
                        </span>
                        <span class="mr-2">
                            <i class="fas fa-circle text-info"></i> Bansos
                        </span>
                    </div>
                </div>
            </div>
